...
exports.getConnection = function _getConnection(collectionName, callback, done) {
  MongoClient.connect(mongoUrl,  {auto_reconnect:true}, function(err, db) {
